...
NO_D1_WARNING=true pnpm wrangler deploy --dry-run --minify --outdir dist src/worker.ts
NO_D1_WARNING=true wrangler r2 object put scm-bucket/worker.js.map --file=dist/worker.js.map
